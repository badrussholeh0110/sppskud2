...
def unit(request):
    ...
    return render(request, 'data/unit.html', context)
...
def peternak(request):
    ...
    return render(request, 'data/peternak.html', context)
...
def harga(request):
    ...
    return render(request, 'data/harga.html', context)
...
def setoran(request):
    ...
    return render(request, 'data/setoran.html', context)
...
def setoran1(request):
    ...
    return render(request, 'data/setoran1.html', context)
@login_required(login_url='login')
def setoran2(request):
    ...
    return render(request, 'data/setoran2.html', context)
